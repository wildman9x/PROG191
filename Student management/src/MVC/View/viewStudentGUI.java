 ...
 * @author wildm
 */
public class viewStudentGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        engGradeField.setEditable(false);
        engGradeField.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N

        mathGradeField.setEditable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(viewStudentGUI.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
