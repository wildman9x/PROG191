...
public class addStudentGUI extends javax.swing.JFrame {
    ...
    private void submitBtnActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_submitBtnActionPerformed
        ...
        MVC.Controller.studentController.registerStudent(name, id, email, phone, address, dob, math, eng, classID);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(addStudentGUI.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
